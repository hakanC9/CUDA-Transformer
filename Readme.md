...
At the time being, the name of the file to be executed after transformation should be given as "applied_optimization_to_the_file.o" (subject to change). Please refer to line 29 in main.cpp file.
